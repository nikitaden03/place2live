...
def print_question(name_index, max_min_value, mood):
    """Returns a question that asks the user about the status of a factor
    ...
    message = (
        f"What is your {name_index} ({mood})? "
...
max_min_safety = max_min_index('safety_index', df.safety_index)
max_min_health = max_min_index('health_care_index', df.health_care_index)
max_min_cost = max_min_index('cost_of_living_index', df.cost_of_living_index)
...
max_min_pollution = max_min_index('pollution_index', df.pollution_index)
max_min_climate = max_min_index('climate_index', df.climate_index)
...
your_health_care_index = (
    float(input(
        print_question('health care index', max_min_health, 'higher is better')
    )) or
    your_health_care_index
)
