...
# it's tuple. For example freedomhouse_score look like ([100.0, ['Sweden', 'Norway', 'Finland']], [1.0, 'Syria'])
...
your_safety_index = (
    float(input("What is your safety index (higher is better)? The best score in the world is {}({}), the worst is {}({}) ".format(
        max_min_safety_index[0][0],*max_min_safety_index[0][1],max_min_safety_index[1][0], max_min_safety_index[1][1])))
...
your_climate_index = (
    float(input("What is your climate index (higher is better)? The best score in the world is {}({}), the worst is {}({}) ".format(
        max_min_climate_index[0][0],*max_min_climate_index[0][1],max_min_climate_index[1][0], max_min_climate_index[1][1])))
...
your_cost_of_living_index = (
    float(input("What is your cost of living index (lower is better)? The best score in the world is {}({}), the worst is {}({}) ".format(
        max_min_cost_of_living_index[0][0],*max_min_cost_of_living_index[0][1],max_min_cost_of_living_index[1][0], 
...
your_property_price_to_income_ratio = (
    float(input("What is your house price to income ratio (lower is better)? The best score in the world is {}({}), the worst is {}({})".format(
        max_min_property_price_to_income_ratio[0][0],*max_min_property_price_to_income_ratio[0][1],max_min_property_price_to_income_ratio[1][0], 
...
your_traffic_commute_time_index = (
    float(input("What is your traffic commute time index (lower is better)? The best score in the world is {}({}), the worst is {}({}) ".format(
        max_min_traffic_commute_time_index[0][0],*max_min_traffic_commute_time_index[0][1],max_min_traffic_commute_time_index[1][0], 
...
your_pollution_index = (
    float(input("What is your pollution index (lower is better)? The best score in the world is {}({}), the worst is {}({})".format(
        max_min_pollution_index[0][0],*max_min_pollution_index[0][1],max_min_pollution_index[1][0], 
